...
# Parameter Bounds
This tutorial shows how to place simple bounds on the values of a model's parameters.  This can be especially useful when building your own objects (see the [custom operator tutorial](CustomOperator)) that might have restrictions on their allowed parameters.
